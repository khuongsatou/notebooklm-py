...
- `origin` points to the upstream `teng-lin/notebooklm-py` repo and is treated as read-only here; push changes through `fork` (`khuongsatou/notebooklm-py`) unless the user explicitly says otherwise.
